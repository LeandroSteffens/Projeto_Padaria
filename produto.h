...
struct produto {
    ...
    int id_produto, vazio, saldo, qnt_estoque, estoque_min;
...
int add_produto(int id){
    ...
    //valor de venda
    id_produto[id].valor_venda = id_produto[id].valor_custo + (id_produto[id].valor_custo * id_produto[id].lucro);
}